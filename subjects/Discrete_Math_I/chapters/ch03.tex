...
One also has the \eax{chromatic polynomial} $P_{G}(k)$ which specifies the number of proper $k$-colorings of $G$ for a given $k$. One can see the recurrence relation 
\begin{align}
